...
public final class ImmortalEntitys {
    public static final EntityType<ImmortalWither> ImmortalWither = registerEntity("immortal_wither", EntityType.Builder.create(ImmortalWither::new, SpawnGroup.MONSTER).makeFireImmune().allowSpawningInside(Blocks.WITHER_ROSE).setDimensions(0.9f, 3.5f).maxTrackingRange(50));
